...
def plot_anomalies_count(anomalies_count, title=""):
    ...
    for i, key in enumerate(texts):
        axis.text((i + 1) * 1.5, y[i] + 10, texts[i], horizontalalignment="center")
    if title != "":
...
if __name__ == "__main__":
    ...
    plot_anomalies_count_dense(global_anomalies_count, "MUL S1 Faults Count")
    anomalies_frequency = {}
    ...
    with open("add_S1_anomalies_count.json", "w") as json_file:
